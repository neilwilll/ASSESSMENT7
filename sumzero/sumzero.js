function hasPairWithSumToZero(nums) {
  ...
  // Example usage:
  const word = "hello";
  const result2 = hasUniqueCharacters(word);
  console.log(result2); // This will log false because 'l' is repeated.
  ...
  const result3 = isPangram(sentence);
  console.log(result3); // This will log true because the sentence is a pangram.
